package org.honton.chas.analyzer.asm.visitors.testcases;
...
public class ArrayCases {
  /**
   * Cause {@link DefaultMethodVisitor#visitMethodInsn(int, String, String, String, boolean)} to be
   * called with primitive array
   *
   * @param source
   * @return
   */
